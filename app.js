...
const convertDbObjectToRespondObject = (dbObject) => {
  return {
...
app.get("/states/", async (request, response) => {
  ...
  response.send(
    allStateArray.map((eachState) => convertDbObjectToRespondObject(eachState))
  );
});
...
app.get("/states/:stateId/", async (request, response) => {
  ...
  response.send(convertDbObjectToRespondObject(stateDetails));
});
...
app.get("/districts/:districtId/", async (request, response) => {
  ...
  response.send(convertDbObjectToRespondObject(districtArray));
});
...
app.get("/districts/:districtId/details/", async (request, response) => {
  ...
  response.send(convertDbObjectToRespondObject(stateName));
});
